...
def index():
    ...
    if request.method == "POST":
        ...
        if option == 'logo_watermark':
            ...
            img.save(os.path.join(app.config['INITIAL_FILE_UPLOADS'], 'image_logo.png'))
            full_filename = 'static\\uploads\\image_logo.png'
            ...
            timg.save(os.path.join(app.config['INITIAL_FILE_UPLOADS'], 'image_text.png'))
            full_filename = 'static\\uploads\\image_text.png'
            return render_template('index.html', full_filename=full_filename)
