...
def index():
	...
	if request.method == "POST":
                ...
                uploaded_image.save("pan_card_tampering\image\original1.png")
                ...
                uploaded_image = cv2.imread("pan_card_tampering\image\original1.png")
                ...
                thresh_img = os.path.join(app.config['GENERATED_FILE'], 'image_original.jpg')
                return render_template('index.html',pred=str(round(score*100,2)) + '%' + ' correct', img=thresh_img)
